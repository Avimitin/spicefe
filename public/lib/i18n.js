...
export const TRANSLATIONS = Object.freeze({
  en: Object.freeze({
    ...
    'setup.directTitle': 'Direct connection',
    'setup.directCopy': 'No relay is used. Allow local-network access when your browser asks, and allow spice2x through Windows Firewall.',
  ...
  'zh-CN': Object.freeze({
    ...
    'setup.title': '连接前须知',
    'setup.directTitle': '直接连接',
    'setup.directCopy': '本应用不使用中继。当浏览器询问时，请允许访问本地网络，并在 Windows 防火墙中放行 spice2x。',
