...
export const TRANSLATIONS = Object.freeze({
  en: Object.freeze({
    ...
    'settings.directCopy': 'No relay is used. Allow local-network access when your browser asks, and allow spice2x through Windows Firewall.',
    'settings.directCopyPublic': 'No relay is used. Allow local-network access when your browser asks, and allow spice2x through Windows Firewall. A private IP address is the most compatible choice on HTTPS.',
  ...
  'zh-CN': Object.freeze({
    ...
    'settings.directCopy': '本应用不使用中继。当浏览器询问时，请允许访问本地网络，并在 Windows 防火墙中放行 spice2x。',
    'settings.directCopyPublic': '本应用不使用中继。当浏览器询问时，请允许访问本地网络，并在 Windows 防火墙中放行 spice2x。HTTPS 模式下使用私有 IP 地址的兼容性最好。',
